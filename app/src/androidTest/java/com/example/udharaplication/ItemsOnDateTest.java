...
public class ItemsOnDateTest {
    @Rule
    public ActivityTestRule<ItemsOnDate> mActivityTestRule =
            new ActivityTestRule<ItemsOnDate>(ItemsOnDate.class);
    public ItemsOnDate topicsActivity = null;
